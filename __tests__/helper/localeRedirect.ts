...
describe('determineLocaleFromUrlAndRewriteUrls', () => {
  const expectedRedirects = [
    ...
    { domain: 'tomtailor.de', pathname: '/', target: '/', determinedLocale: 'de_DE' },
    { domain: 'tomtailor-de.vercel.app', pathname: '/', target: '/', determinedLocale: 'de_DE' },
    { domain: 'tomtailor.de', pathname: '/damen', target: '/damen', determinedLocale: 'de_DE' },
    ...
    { domain: 'tomtailor-staging-ch.vercel.app', pathname: '/de_DE/de/de', target: '/de', determinedLocale: 'de_CH' },
    { domain: 'tomtailor-staging-ch.vercel.app', pathname: '/de_DE/de', target: '', determinedLocale: 'de_CH' },

    { domain: 'tomtailor.ch:3000', pathname: '/de', target: '', determinedLocale: 'de_CH' },
    { domain: 'tomtailor.ch:3000', pathname: '/de_DE', target: '/de/', determinedLocale: 'de_CH', redirect: true },
    { domain: 'tomtailor.ch:3000', pathname: '/de_DE/', target: '/de/', determinedLocale: 'de_CH', redirect: true },

    { domain: 'tomtailor-ch.vercel.app', pathname: '/', target: '/de/', determinedLocale: 'de_CH', redirect: true },
    { domain: 'tomtailor-ch.vercel.app', pathname: '/fr', target: '', determinedLocale: 'fr_CH' },
    { domain: 'tomtailor-ch.vercel.app', pathname: '/de/damen', target: '/damen', determinedLocale: 'de_CH' },
    { domain: 'tomtailor-ch.vercel.app', pathname: '/fr/damen', target: '/damen', determinedLocale: 'fr_CH' },
